...
export const wasmpartruntime_applySketchCommandsJson: (a: number, b: number, c: number) => [number, number, number, number];
...
export const wasmpartruntime_exportSketchDxfJson: (a: number, b: number, c: number) => [number, number, number, number];
...
export const wasmpartruntime_importSketchDxfJson: (a: number, b: number, c: number) => [number, number, number, number];
