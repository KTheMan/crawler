...
export class WasmPartRuntime {
    ...
    applySketchCommandsJson(request_json: string): string;
    ...
    exportSketchDxfJson(request_json: string): string;
    exportStep(): string;
    exportStl(): string;
    ...
    importSketchDxfJson(request_json: string): string;
...
export interface InitOutput {
    ...
    readonly wasmpartruntime_applySketchCommandsJson: (a: number, b: number, c: number) => [number, number, number, number];
    ...
    readonly wasmpartruntime_exportSketchDxfJson: (a: number, b: number, c: number) => [number, number, number, number];
    ...
    readonly wasmpartruntime_importSketchDxfJson: (a: number, b: number, c: number) => [number, number, number, number];
